...
public enum Messages {
	...
	ITEM_GIVEN("You have been given %0", TextColor.fromHexString("#38ff47")),
	ITEM_GIVEN_TO("You have given %0 to %1", TextColor.fromHexString("#38ff47")),
	ITEM_GIVEN_TO_YOU("You have been given %0 by %1", TextColor.fromHexString("#38ff47")),
	YOU_CANNOT_PUT_ANVIL("You cannot put this item in the anvil", TextColor.fromHexString("#ff3510")),
	ITEM_REPAIRED("You have repaired %0", TextColor.fromHexString("#38ff47"));
